...
export function Modal({onClose}: {onClose: () => void}) {
    return <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-slate-400 bg-opacity-80 flex justify-center" onClick={() => {
        onClose();
    }}>
